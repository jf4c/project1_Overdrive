...
<html lang="en">
    ...
    <body>
        <header>
            ...
            <nav>
                <ul>
                    <li><a class="add" href="form.php">Usuarios</a></li>
                    <li><a class="add" href="form.php">empresas</a></li>
                ...
                <tbody>
                   <?php
                        while($user_data = mysqli_fetch_assoc($result)){
                            echo "<tr>";
                            echo "<td class='centro'>".$user_data['name']."</td>";
                            echo "<td class='centro'>".$user_data['Email']."</td>";
